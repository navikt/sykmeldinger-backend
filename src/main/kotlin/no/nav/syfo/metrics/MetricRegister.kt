...
val SENDT_AV_BRUKER_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("sendt_counter")
...
val CLIENT_ASSERTION_HISTOGRAM: Histogram = Histogram.Builder()
    .name("client_assertions_duration_seconds")
    .help("durations for creating signed client assertions in seconds")
    .register()

val MISSING_DATA_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("missing_data")
    .labelNames("data")
