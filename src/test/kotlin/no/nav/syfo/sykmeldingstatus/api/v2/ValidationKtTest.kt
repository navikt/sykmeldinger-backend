    ...
    FunSpec(
        {
            context("Validation") {
                ...
                context("arbeidssituasjon") {
                    context("fisker") {
                        test(
                            "Skal kaste exception dersom arbeidssituasjon er fisker men ingen fisker-svar",
                        ) {
                            val sykmeldingFormResponse =
                                SykmeldingFormResponse(
                                    erOpplysningeneRiktige =
                        ...
                        test(
                            "Skal kaste exception dersom fisker er på Hyre og mangler arbeidsgiver-nummer",
                        ) {
                            val sykmeldingFormResponse =
                                SykmeldingFormResponse(
                                    erOpplysningeneRiktige =
                        ...
                        test(
                            "Skal gå fint for en vanlig Hyre fisker på Blad A",
                        ) {
                            val sykmeldingFormResponse =
                                SykmeldingFormResponse(
                                    erOpplysningeneRiktige =
                        ...
                        test(
                            "Skal gå fint for en vanlig Lott fisker på Blad A",
                        ) {
                            val sykmeldingFormResponse =
                                SykmeldingFormResponse(
                                    erOpplysningeneRiktige =
            ...
            context("SporsmalOgSvar builders") {
                ...
                test(
                    "Skal lage SporsmalOgSvarDTO for riktigNarmesteLeder med inaktiv arbeidsgiver",
                ) {
                    val sykmeldingFormResponse =
                        SykmeldingFormResponse(
                            erOpplysningeneRiktige =
