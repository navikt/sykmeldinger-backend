    ...
    FunSpec(
        {
            ...
            context("inserting status") {
                test("status for arbeidsledig should be inserted with form values") {
                    TestDB.database.insertStatus(
                        "1",
                        getStatus(
                ...
                test("status for arbeidstaker should be inserted with form values") {
                    TestDB.database.insertStatus(
                        "1",
                        getStatus(
                            StatusEventDTO.APEN.name,
